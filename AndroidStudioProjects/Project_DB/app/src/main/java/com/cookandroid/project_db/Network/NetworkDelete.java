...
public class NetworkDelete extends AsyncTask<String,Void,String> {
    ...
    private URL Url;
    private String URL_Address="http://localhost:8080/testWeb/testDB3_delete.jsp";
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            ...
            //content-type
            con.setRequestProperty("Content-type","application/x-www-form-urlencoded,chatset=utf-8");
